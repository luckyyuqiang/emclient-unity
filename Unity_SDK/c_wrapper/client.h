...
HYPHENATE_API void* AGORA_CALL Client_InitWithOptions(Options *options, FUNC_OnConnected, FUNC_OnDisconnected, FUNC_OnPong, FUNC_onTokenNotification);
HYPHENATE_API void AGORA_CALL Client_AddMultiDeviceListener(FUNC_onContactMultiDevicesEvent, FUNC_onGroupMultiDevicesEvent, FUNC_undisturbMultiDevicesEvent, FUNC_onThreadMultiDevicesEvent threadEventFunc);
